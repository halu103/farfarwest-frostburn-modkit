...
$manifest = [pscustomobject]@{
    ...
    mod = [pscustomobject]@{
        ...
        sessionRows = [int]$mod.sessionRows
        soloInviteSlots = [int]$mod.soloInviteSlots
        deploymentMode = [string]$mod.deploymentMode
        vanillaClientCompatibility = [string]$mod.vanillaClientCompatibility
